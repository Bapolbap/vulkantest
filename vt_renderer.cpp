...
namespace vt {
    ...
    VtRenderer::~VtRenderer() { freeCommandBuffers(); }
    ...
    void VtRenderer::beginSwapChainRenderPass(VkCommandBuffer commandBuffer) {
        assert(isFrameStarted && "can't beginSwapChainRenderPass if frame not in progress");
    ...
    void VtRenderer::endSwapChainRenderPass(VkCommandBuffer commandBuffer) {
        assert(isFrameStarted && "can't endSwapChainRenderPass if frame not in progress");
